            ...
            <div id="book_recommend">
                <div id="book">
                    <form action="book/refer" method="post">
                        ...
                        <div id="book-collect">
                            <span class="collect-icon">收藏</span>
                            ...
                            <span class="collect-score"><span >评分：</span><?php
                                ...
                                if($level%20!=0){
                                    for($i=1;$i<$level/20;$i++){
                                        echo '<img width="20" height="20" src="assets/img/xingxing1.png">';
                                    }
                                    echo '<img width="20" height="20" src="assets/img/xing.png">';
                                    for($i=1;$i<5-$level/20;$i++){
                                        echo '<img width="20" height="20" src="assets/img/xingxing.png">';
                                    }
                                }else{
                        ...
                        <div id="book-sub">
                            <input type="button" id="book-refer" value="马上预订">
<!--                            <a href="javascript"></a>-->
                        </div>
                    </div>
                    </form>
